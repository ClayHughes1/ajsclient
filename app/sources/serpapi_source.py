...
class SerpApiSource:
    ...
    def _normalize_job(
        ...
        posting_url = self._get_posting_url(
            result
        )
        ...
        # Employment type
        #
        # Google Jobs commonly exposes this through
    ...
    def _get_posting_url(
        ...
        # ---------------------------------------------------------
        # Google Jobs provides a share_link that represents the
        # Google Jobs posting.
        #
        # Fall back to the first application link if share_link
        # isn't available.
        # ---------------------------------------------------------

        share_link = result.get(
            "share_link",
            ""
        )
    ...
    def _get_posting_date(
        ...
        posted_at = detected_extensions.get(
            "posted_at"
        )
